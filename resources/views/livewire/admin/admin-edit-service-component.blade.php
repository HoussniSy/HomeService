                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" wire:submit.prevent="updateService">
                                            ...
                                            <div class="from-group">
                                                <label for="slug" class="control-label col-sm-3">Feactured: </label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="from-group">
                                                <label for="img" class="control-label col-sm-3">Thumbnail: </label>
                                                <div class="col-sm-9">
                                            ...
                                            <div class="from-group">
                                                <label for="img" class="control-label col-sm-3">Image: </label>
                                                <div class="col-sm-9">
