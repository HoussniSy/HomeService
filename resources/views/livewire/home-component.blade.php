...
<section class="tp-banner-container">
            ...
            <div class="filter-title">
                <div class="title-header">
                    ...
                    <p class="lead">Réservez un service à prix très abordable, </p>
                </div>
                <div class="filter-header">
                    <form id="sform" action="{{route('searchService')}}" method="post">  
                        @csrf                      
                        <input type="text" id="q" name="q" required="required" placeholder="Quels services voulez-vous?"
        ...
        <section class="content-central">
            ...
            <div class="content_info">
                <div>
                    <div class="container">
                        <div class="row">
                            <div class="titles">
                                <h2>3sFEEWNENAM <span>Choix</span> de Services</h2>
                            ...
                            <div class="col-xs-6 col-sm-4 col-md-3 hsgrids"
                                ...
                                <a class="g-list" href="{{route('home.service_details',['service_slug'=>$service->slug])}}">
                                    ...
                                    <div class="info-gallery">
                                        ...
                                        <div class="price"><span>MRU</span><b>From</b>{{$service->price}}</div>
                                    </div>
                                </a>
                            </div>
                            @endforeach
                        ...
                        <div class="row">
                            <div class="col-md-4 ">
                                <div class="services-lines-info">
                                    <h2>BIENVENUE CHEZ SERVICES DEPANNAGES</h2>
                                    <p class="lead">
                                        Réservez les meilleurs services au même endroit.
                                        <span class="line"></span>
                                    </p>

                                    <p>Trouvez une grande variété de services à domicile.</p>
                                </div>
                            </div>
                            <div class="col-md-8">
            ...
            <div>
                <div class="container">
                    <div class="row">
                        <div class="titles">
                            <h2><span>Appareil</span>Services</h2>
                            <i class="fa fa-plane"></i>
                            <hr class="tall">
                        </div>
                    </div>
                        ...
                        <a class="g-list" href="{{route('home.service_details',['service_slug'=>$aservice->slug])}}">
                            ...
                            <div class="info-gallery">
                                ...
                                <div class="content-btn"><a href="{{route('home.service_details',['service_slug'=>$aservice->slug])}}"
                                        class="btn btn-primary">Réservez maintenant</a></div>
                                <div class="price"><span>MRU</span><b>From</b>{{$aservice->price}}  MRU</div>
                            </div>
                        </a>
                    </div>
                    @endforeach
