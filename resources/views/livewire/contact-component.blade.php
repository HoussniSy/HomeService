                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <aside>
                                    <h4>The Office</h4>
                                    <address>
                                        <strong>3sFEEWNENAM Home Services.</strong><br>
                                        <i class="fa fa-map-marker"></i><strong>Address: </strong>Nouakchott, Riyad,
                                        Mauritanie<br>
                                        <i class="fa fa-phone"></i><strong>Phone: </strong> +222-1234567890
                                    </address>
                                    <address>
                                        <strong>3sFEEWNENAM Emails</strong><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:contact@surfsidemedia.in"> contact@gmail.com</a><br>
                                        <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                            href="mailto:support@surfsidemedia.in"> support@gmail.com</a>
                                    </address>
                                </aside>
                                <hr class="tall">
                            </div>
