                                        ...
                                        <div class="panel-body">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td style="border-top: none;"><span>MRU :</span> {{$service->price}}</td>
                                                </tr>
                                                <tr>
                                                    <td>Quantité</td>
                                                    <td>1</td>
                                                ...
                                                <tr>
                                                    <td>Total</td>
                                                    <td><span>MRU :</span> {{$total}}</td>
                                                </tr>
                                            </table>
                                        </div>
                                        <div class="panel-footer">
                                        <a href="{{route('home.change_location')}}"
                                                class="btn btn-primary">Réservez maintenant</a>
                                        </div>
                                    </div>
                                </aside>
                                <aside>
                                    @if($r_service)
                                    <h3>Service connecté</h3>
                                    <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                        ...
                                        <a href="{{route('home.service_details',['service_slug'=>$r_service->slug])}}">
                                            ...
                                            <div class="info-gallery">
                                                ...
                                                <div class="price"><span>MRU :</span><b>From</b>{{$r_service->price}}</div>
                                            </div>
                                        </a>
                                    </div>
                                    @endif
